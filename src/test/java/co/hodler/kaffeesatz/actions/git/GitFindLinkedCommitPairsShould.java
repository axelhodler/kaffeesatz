...
public class GitFindLinkedCommitPairsShould {
  ...
  public void initialize() {
    provider = new GitFindLinkedCommitPairs(gitRepoInteractions);
  }
  ...
  public void pairLinkedCommitIdsFromLog() {
    ...
    given(gitRepoInteractions.provideOrderedLogOfCommitHashes()).willReturn(commitLog);

    Set<LinkedCommitHashPair> pairs = provider.providePairs();

    verify(gitRepoInteractions).provideOrderedLogOfCommitHashes();
    assertThat(pairs,
